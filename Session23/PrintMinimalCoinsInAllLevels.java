class Sample
{
	...
	public int minmalCoins(int[] coins, int capacity)
	{
		...
		printAllPoosibleCoins(coins,capacity,dp);
		return dp[n-1][capacity];

	}


	public void printAllPoosibleCoins(int[] coins, int capacity, int[][] dp)
	{

		for(int i = coins.length - 1 ; i >= 0 ; i --)
		{
			System.out.println("Possible Minimal Coins @ Level-Index => "+i);
			printSelectedCoinsForGivenElements(coins,capacity,dp,i);
			System.out.println("\n");
			
		}
	}

	public void printSelectedCoinsForGivenElements(int[] coins , int capacity,int[][] dp,int length)
	{
		int i = length;
	...
	public class PrintMinimalCoinsInAllLevels
	{
